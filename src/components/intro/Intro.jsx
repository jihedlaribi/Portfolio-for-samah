...
import "./intro.css"
import me from "../../img/samahimg.png"
const Intro = () => {
  return (
    <div className='i'>
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Samah Hamdi</h1>
      ...
      <p className="i-desc">Titulaire de master en e-marketing de l ESSEC de Tunis, Enseignante Spécialiste en marketing et communication. 
 </p>
